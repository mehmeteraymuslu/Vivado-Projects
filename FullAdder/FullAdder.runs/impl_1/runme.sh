...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/FullAdder/FullAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Adder_2.tcl -notrace
