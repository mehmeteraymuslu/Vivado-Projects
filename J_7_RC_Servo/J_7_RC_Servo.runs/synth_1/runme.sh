...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/J_7_RC_Servo/J_7_RC_Servo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RC_servo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RC_servo.tcl
