...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/Memory/Memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryBlock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemoryBlock.tcl -notrace
