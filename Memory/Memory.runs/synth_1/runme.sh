...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/Memory/Memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemoryBlock.tcl
