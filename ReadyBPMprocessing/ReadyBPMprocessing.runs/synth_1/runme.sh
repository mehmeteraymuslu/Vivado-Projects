...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/ReadyBPMprocessing/ReadyBPMprocessing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_bmp_sink.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_bmp_sink.tcl
