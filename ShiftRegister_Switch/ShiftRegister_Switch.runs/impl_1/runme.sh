...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/ShiftRegister_Switch/ShiftRegister_Switch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegister_Switch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ShiftRegister_Switch.tcl -notrace
