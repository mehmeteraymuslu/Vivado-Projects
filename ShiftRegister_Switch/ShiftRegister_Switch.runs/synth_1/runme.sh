...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/ShiftRegister_Switch/ShiftRegister_Switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegister_Switch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShiftRegister_Switch.tcl
