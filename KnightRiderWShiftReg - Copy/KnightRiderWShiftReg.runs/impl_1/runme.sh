...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/KnightRiderWShiftReg/KnightRiderWShiftReg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KnightRiderTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KnightRiderTop.tcl -notrace
