...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/FullAdder/FullAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_Adder_2.tcl
