...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/FIFO/FIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFOTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFOTop.tcl -notrace
