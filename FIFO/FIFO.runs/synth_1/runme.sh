...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/FIFO/FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFOTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFOTop.tcl
