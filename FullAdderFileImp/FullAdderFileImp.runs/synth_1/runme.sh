...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/FullAdderFileImp/FullAdderFileImp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_2_FA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_carry_adder_2_FA.tcl
