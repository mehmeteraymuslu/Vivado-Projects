...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/ClockDivider/ClockDivider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockDividerTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ClockDividerTop.tcl -notrace
