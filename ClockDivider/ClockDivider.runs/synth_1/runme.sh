...
HD_PWD='C:/Users/eray.muslu/Desktop/Vivado Projects/ClockDivider/ClockDivider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockDividerTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockDividerTop.tcl
